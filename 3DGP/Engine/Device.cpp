...
void Device::Init()
{
...
#ifdef _DEBUG
	::D3D12GetDebugInterface(IID_PPV_ARGS(&_debugController)); // IID_PPV_ARGS - 해당 타입의 아이디와 포인터를 가져옴
	...
	// 여기 적힌 레벨이 DX버전의 그래픽카드 최소 수치임 즉, 현재 이 프로그램은 최소한 DX11버전의 그래픽카드를 사용할 것을 권고함
}
